...
// Adding elements:
elements.lipton = {
    color: "#ffa500", // Orange color (you can adjust as needed)
    behavior: behaviors.LIQUID,
    category: "liquids",
    viscosity: 10000, // Adjust viscosity as needed
    state: "liquid",
    density: 1020, // Adjust density as needed
};

// Changing existing elements (example provided for water):
...
elements.water.reactions.lipton = { "elem1":null, "elem2":"lipton_water" }
...
if (enabledMods.includes("mods/test.js")) {
    runAfterLoad(function() {
        // Your code here
        console.log("Lipton mod loaded with test mod!");
    });
}
